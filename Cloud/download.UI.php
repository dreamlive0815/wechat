...
<div class="container">
    ...
    function callAPI(args)
    {
        ...
        var url = args.url || 'index.php';
        var data = args.data || { action : '' };
...
?>
    <div>
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="url" id="url" rows="20"></textarea>
        </div>
        <div class="form-group">
            <button id="upload" class="btn btn-default form-control">确定</button>
        </div>

        <!--div class="form-group">
            <button id="getinfo" class="btn btn-default form-control">getinfo</button>
        </div-->
    </div>
    <script>
    ...
    function download(url)
    {
        ...
        var realURL = 'download.php?id=' + url;
        window.open(realURL);
    }
    </script>
<?php
